...
namespace Contoso.Events.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult SignIn(string id)
        {
            ...
            string signInSheetName = String.Format("{0}_SignIn.docx", viewModel.Document.EventKey);

            return File(viewModel.Document.Document, "application/msword", signInSheetName);
        }
