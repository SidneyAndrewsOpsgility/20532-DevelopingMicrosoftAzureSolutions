...
> **Results**: After completing this exercise, you will have used the Management Portal to create Website instances.
...
* Publish a web application by using the publish wizard in Visual Studio 2013.
