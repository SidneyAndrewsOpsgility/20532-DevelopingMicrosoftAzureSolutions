...
2. Install the trail version of **Visual Studio 2013 Ultimate** by selecting only the following optional features:
...
4. Start **Visual Studio 2013 Ultimate** and allow the first-run experience to complete.
...
2. In Web Platform Installer, install the **Windows Azure SDK for .NET (VS 2013) – 2.5** package.
