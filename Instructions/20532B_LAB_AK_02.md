...
Click **Continue**.<span id="List_218"
class="anchor"></span>
...
a.  In the **Storage** dialog
 box, provide the value

**stor20532[Your Name Here]**.
...
a.  In the **Destination folder** dialog box, provide the value **F:\\**.
...
In the Address bar, type **http://go.microsoft.com/fwlink/?LinkID=525334**.
...
To view this dialog box, in the yellow
...
2015 Community Edition** installation to finalize.



In the **Visual Studio Ultimate
2015** dialog box, click **Launch**.
...
>  **Note:** It might take a minute or two for the
 ...
 will retrieve the Azure SDK for .NET 2.6.



Verify that the package is
 named **Microsoft** **Azure SDK for .NET (VS 2015) – 2.6**.
Click **Install**.
