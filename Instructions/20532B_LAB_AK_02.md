...
9. In the **Storage account** blade that displays, perform the following steps:
  ...
  e. In the **Recommended Pricing Tiers** blade, select the **L LRS** option for local redundancy.
...
5. In the **New** blade that displays, click **Computer** and then click **Windows Server 2012 R2 Datacenter**.
