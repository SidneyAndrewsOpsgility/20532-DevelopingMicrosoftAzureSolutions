...
> Occasionally the Preview Portal may not successfully create a new service instance. The portal is still technically in preview and can potentially have unresolved bugs. If this happens, you can simply retry the operation until your service instance is successfully created.
...
1. In Visual Studio, open the **Contoso.Events** solution from the following location:
  ...
  - File location: **Allfiles (F):\\Mod04\\Labfiles\\Starter\\SQL\\Contoso.Events**
